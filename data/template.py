...
logger = logger.bind(name="template")

from .data_utils import Role
from .formatter import EmptyFormatter, FunctionFormatter, StringFormatter, ToolFormatter
from .mm_plugin import get_mm_plugin, BasePlugin
        ...
        for elem in elements:
            if isinstance(elem, str):
                if len(elem) != 0:
                    ...
                    # token_ids += tokenizer.encode(elem, add_special_tokens=False, max_length=2048, padding=True, truncation=True, padding_side="left")
